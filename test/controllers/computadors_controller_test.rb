...
class ComputadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computador" do
    assert_difference('Computador.count') do
      post computadors_url, params: { computador: { marca: @computador.marca, procesador: @computador.procesador, ram: @computador.ram } }, as: :json
    end
  ...
  test "should update computador" do
    patch computador_url(@computador), params: { computador: { marca: @computador.marca, procesador: @computador.procesador, ram: @computador.ram } }, as: :json
    assert_response 200
  end
