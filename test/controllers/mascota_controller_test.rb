...
class MascotaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mascotum" do
    assert_difference('Mascotum.count') do
      post mascota_url, params: { mascotum: { color: @mascotum.color, nombre: @mascotum.nombre, raza: @mascotum.raza } }, as: :json
    end
  ...
  test "should update mascotum" do
    patch mascotum_url(@mascotum), params: { mascotum: { color: @mascotum.color, nombre: @mascotum.nombre, raza: @mascotum.raza } }, as: :json
    assert_response 200
  end
