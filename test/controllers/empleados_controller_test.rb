...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { apellido: @empleado.apellido, edad: @empleado.edad, nombre: @empleado.nombre } }, as: :json
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { apellido: @empleado.apellido, edad: @empleado.edad, nombre: @empleado.nombre } }, as: :json
    assert_response 200
  end
