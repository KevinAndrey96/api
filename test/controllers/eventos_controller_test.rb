...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { direccion: @evento.direccion, nombre: @evento.nombre, tipo: @evento.tipo } }, as: :json
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { direccion: @evento.direccion, nombre: @evento.nombre, tipo: @evento.tipo } }, as: :json
    assert_response 200
  end
